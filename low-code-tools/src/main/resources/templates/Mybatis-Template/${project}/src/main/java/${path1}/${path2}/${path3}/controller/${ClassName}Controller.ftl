...
public class ${ClassName}Controller {
    ...
    */
    ...
    public ApiResult insert (@RequestBody ${ClassName} ${ClassName?lower_case}) {
        int affectRows = service.insert(${ClassName?lower_case});
    ...
    */
    ...
    public ApiResult update (@RequestBody ${ClassName} ${ClassName?lower_case}) {
        int affectRows = service.update(${ClassName?lower_case});
        return new ApiResult<>(ResultCode.success.getCode(), affectRows, ResultCode.success.getMessage());
    }
    ...
    */
    ...
    public ApiResult selectPage (@RequestBody JSONObject object) {
        ...
        ${ClassName} ${ClassName?lower_case} = object.toJavaObject(${ClassName}.class);
        PageList<${ClassName}> pageList = service.selectPage(${ClassName?lower_case}, page, pageSize);
